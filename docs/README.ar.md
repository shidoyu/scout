...
أضف [Context7](https://github.com/upstash/context7) للوصول المباشر إلى وثائق المكتبات وأُطر العمل. تجريد النصوص الزائدة عبر Jina Reader مُدمج تلقائيًا — لا حاجة لأي إعداد. يُزيل تلقائيًا ضوضاء الصفحة فيشغل النص سياقك بشكل أقل.
