...
أضف [Context7](https://github.com/upstash/context7) للوصول المباشر إلى توثيق المكتبات والأطر، و[Jina Reader](https://jina.ai) لتجريد صفحات الويب من العناصر الزائدة وتقليل الضوضاء في سياقك. لا تحتاج إلى API key لأي منهما — Jina يعمل مجانًا بحد 20 req/min دون حصة.
