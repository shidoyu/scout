...
أضف [Context7](https://github.com/upstash/context7) للوصول المباشر إلى توثيق المكتبات/أُطر العمل، و[Jina Reader](https://jina.ai) لقراءة أنظف للصفحات. Context7 لا يحتاج مفتاح API؛ مفتاح اختياري لـ Jina لحدود المعدل.
