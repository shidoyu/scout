...
הוסיפו את [Context7](https://github.com/upstash/context7) לגישה ישירה לתיעוד של ספריות ו-frameworks. הסרת תוכן מיותר באמצעות Jina Reader מובנית — אין צורך בהגדרות. רעשי עמוד מסוננים אוטומטית כך שפחות טקסט תופס מקום בהקשר שלכם.
