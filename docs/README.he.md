...
הוסיפו את [Context7](https://github.com/upstash/context7) לגישה ישירה לתיעוד של ספריות ו-frameworks. Jina Reader מסיר את רעשי הדף, כך שפחות טקסט תופס את ההקשר שלכם ונחסכים טוקנים. עובד בלי מפתח (20 req/min); מפתח API חינמי פותח 500 req/min.
