...
הוסיפו [Context7](https://github.com/upstash/context7) לגישה ישירה לתיעוד ספריות/פריימוורקים, ו-[Jina Reader](https://jina.ai) לקריאת דפים נקייה יותר. Context7 לא דורש מפתח API; מפתח אופציונלי ל-Jina להגבלות קצב.
