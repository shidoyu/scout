...
लाइब्रेरी और फ्रेमवर्क के दस्तावेज़ों तक सीधे पहुंच के लिए [Context7](https://github.com/upstash/context7) जोड़ें। Jina Reader पेज का शोर हटाता है, जिससे आपका कॉन्टेक्स्ट कम टेक्स्ट से भरता है और टोकन बचते हैं। यह बिना key के काम करता है (20 req/min); एक मुफ्त API key 500 req/min अनलॉक करती है।
