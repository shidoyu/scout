...
Tambahkan [Context7](https://github.com/upstash/context7) untuk akses langsung ke dokumentasi library/framework, dan [Jina Reader](https://jina.ai) untuk pembacaan halaman yang lebih bersih. Context7 tidak memerlukan API key; key opsional untuk batas rate Jina.
