...
添加 [Context7](https://github.com/upstash/context7) 以直接访问库和框架的文档。Jina Reader 会去除页面噪音，让更少的文本占用你的上下文，并节省 token。无需 key 即可使用（20 req/min）；免费的 API key 可解锁 500 req/min。
