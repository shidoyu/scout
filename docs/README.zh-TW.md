...
加入 [Context7](https://github.com/upstash/context7) 以直接存取函式庫與框架的文件。Jina Reader 會移除頁面雜訊，讓更少的文字佔用你的上下文，並節省 token。無需 key 即可使用（20 req/min）；免費的 API key 可解鎖 500 req/min。
